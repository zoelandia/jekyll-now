...
That's a total of 291,513 weekday riders. I checked this with the number on the MTA site (same link as above), and it doesn't seem obviously wrong; the MTA lists Grand Central's annual ridership as 46,737,564, which would be 128,048 per day if we average it across the year, ignoring variations due to weekday/weekend/holiday trends.
